...
------------------------------------------------------------------------------
-- Implementation of a r/w property 'current_ino' for the panel:

-- Getter: returns the inode # of the current file.
function ui.Panel.meta:get_current_ino()
  local _, stat = self:get_current()
  return stat.ino
end

-- Setter: sets the current file to the one having a certain inode #.
