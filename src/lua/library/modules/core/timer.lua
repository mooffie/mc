...
--
-- As with JavaScript in a browser, there's [no guarantee](http://ejohn.org/blog/how-javascript-timers-work/)
-- about the _exact_ time your function will be called.
--
