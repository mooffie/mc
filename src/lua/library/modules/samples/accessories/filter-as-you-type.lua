...
provides the same functionality, and even better. So you have a choice!)
...
MC has a find-as-you-type feature (C-s, or M-s), but not a filter-as-you-type
feature. Here we fill in this void.
...
local M = {
  ...
  -- The delay, in milliseconds, before setting the filter. The keys here are
  -- the filesystem prefixes. "localfs" is for the local filesystem.
  delay = {
    default = 100,
    sh = 1000,  -- For FISH (the network filesystem) we wait 1 sec before filtering.
  }
