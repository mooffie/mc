...
local tobinary, tohex, tooct, tointeger, baseconv = import_from('samples.apps.calc.utils', { 'tobinary', 'tohex', 'tooct', 'tointeger', 'baseconv' })
...
M.renderers = {
  ...
  hex = function(f, i, addsepf)
    return i and addsepf(tohex(i), 4, ' ') or T'n/a'
  end,

  oct = function(f, i)
    return i and tooct(i) or T'n/a'
  end,
